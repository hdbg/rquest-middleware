...
mod test {
    ...
    use rquest::Response;
    use rquest_middleware::{ClientBuilder, ClientWithMiddleware, Extension};
    ...
    async fn make_echo_request_in_otel_context(client: ClientWithMiddleware) -> Response {
        ...
        TELEMETRY.get_or_init(|| {
            let subscriber = Registry::default().with(
                filter::Targets::new().with_target("rquest_tracing::otel::test", Level::DEBUG),
            );
            ...
            let subscriber = {
                ...
                let tracer = provider.versioned_tracer("rquest", None::<&str>, None::<&str>, None);
            ...
            let subscriber = {
                ...
                let tracer = provider.tracer_builder("rquest").build();
            ...
            let subscriber = {
                ...
                let tracer = provider.tracer("rquest");
